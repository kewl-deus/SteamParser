...
public class MapControllerAction extends Action
{
            ...
            throws IOException, ServletException
    {
        ...
        MapTableModel model = (MapTableModel) session
                .getAttribute("mapStatsTable");
        ...
        session.setAttribute("mapStatsTable", model);
