...
public class PlayerControllerAction extends Action
{
            ...
            throws IOException, ServletException
    {
        ...
        PlayerTableModel model = (PlayerTableModel) session
                .getAttribute("playerStatsTable");
        ...
        session.setAttribute("playerStatsTable", model);
